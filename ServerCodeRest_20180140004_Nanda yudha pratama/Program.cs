...
using ServiceRest_20180140004_Nanda_yudha_pratama;
using System.ServiceModel.Description;
using System.ServiceModel.Channels;
using System.ServiceModel.Web;

namespace ServerCodeRest_20180140004_Nanda_yudha_pratama
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri address = new Uri("http://localhost:1999/Mahasiswa");
